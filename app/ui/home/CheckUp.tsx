...
export default function CheckUp() {
  return (
    <section className="p-5 mx-4 lg:pr-0 xl:p-8 xl:mx-2 rounded-2xl border border-gray-200 bg-white shadow-sm mt-12 sm:mt-28 lg:mt-0 flex flex-col lg:flex-row lg:gap-6 xl:gap-28 shadow-gray-200">
      <div className="h-[210px] sm:h-[280px] w-[110%] self-center relative lg:hidden">
        <div className="w-full absolute -top-32 flex flex-col gap-2 sm:gap-3 md:gap-5">
          <div className="flex gap-4 sm:gap-10 justify-center">
            <Image
              src={family1}
              alt="family1"
              className="self-end rounded-full h-14 w-14 sm:w-18 sm:h-18 object-cover shadow-sm"
            />
      ...
      <div className="min-w-[45%] xl:min-w-[44%] self-center xl:ml-auto -top-4 xl:-top-12 relative lg:inline-block hidden xl:scale-108">
        <div className="w-full absolute -top-32 flex flex-col gap-2 sm:gap-3 md:gap-5 lg:gap-3">
          <div className="flex gap-4 sm:gap-10 lg:gap-4 justify-center">
            ...
            />
            <div className="self-start relative -top-10 p-4 sm:p-5 lg:p-4 bg-gray-100 rounded-2xl flex justify-between items-center gap-4 max-w-[260px] sm:max-w-[340px] md:max-w-[380px] lg:max-w-[340px] shadow-sm shadow-gray-200">
          ...
          <div className="flex gap-4 justify-center relative sm:gap-10 -left-6 lg:gap-8 lg:-left-2 lg:justify-start">
            <div className="self-end p-4 sm:p-5 lg:p-4 xl:p-5 bg-amber-200 rounded-2xl flex justify-between items-center gap-4 max-w-[240px] sm:max-w-[320px] md:max-w-[360px] lg:max-w-[240px] xl:max-w-[320px] shadow-sm shadow-gray-200">
          ...
          <div className="flex justify-center gap-4 sm:gap-10 relative top-4 lg:gap-4">
            ...
            />
            <div className="relative -right-4 self-end p-4 sm:p-5 lg:p-4 xl:p-5 bg-purple-200 rounded-2xl flex justify-between items-center gap-4 max-w-[260px] sm:max-w-[340px] md:max-w-[380px] lg:max-w-[260px] xl:max-w-[340px] shadow-sm shadow-gray-200">
              <p className=" text-gray-700 text-xs sm:text-sm lg:text-xs xl:text-sm font-medium">
                discovers an unknown condition during annual exams.
              </p>
