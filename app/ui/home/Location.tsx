...
export default function Location() {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-3 justify-items-start gap-4 lg:gap-4 items-stretch justify-center px-2 drop-shadow-none lg:drop-shadow-gray-200">
