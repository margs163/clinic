...
const contacts: Contact[] = [
  {
    ...
    description: "Немедленная медицинская помощь",
  ...
  },
  {
    ...
    description: "Посетите нас по адресу",
    info: "ул.Бекхожина 23, Павлодар",
  ...
  },
  {
    icon: CalendarCheck,
    title: "Часы работы",
    description: "Время приёма пациентов",
    info: ["Пн-Пт: 8:00 - 19:00", "Сб: 8:00 - 12:00"],
    ...
    <section className="flex flex-col gap-6 lg:gap-10 justify-start">
      <div className="space-y-2 text-center">
        ...
        <p className="text-sm font-medium text-gray-500 lg:text-base lg:max-w-[50%] lg:mx-auto">
          Готовы сделать следующий шаг в своем медицинском путешествии?
