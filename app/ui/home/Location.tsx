...
export default function Location() {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-3 justify-center items-start gap-6 px-10">
      ...
      {contacts.map((item, index) => {
        ...
        return (
          <div
            key={index}
            className="flex flex-col items-center justify-start gap-2 p-6 bg-white shadow-md rounded-lg border border-gray-100"
          >
            <Icon
              strokeWidth={1.6}
            ...
            <div className="space-y-1 text-center">
              ...
              {index === contacts.length - 1 ? (
                <div className="text-sm">
                  <h3 className="text-gray-700 font-medium">{item.info[0]}</h3>
